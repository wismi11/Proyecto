...
class AdminContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '', 'dbname' => 'prestashop_compu', 'user' => 'prestashop_proyecto', 'password' => '#pJf2X7aO2', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/var/www/vhosts/pruebas.devblinders.com/proyectointegrado.ismael.com/modules/productcomments/src/Entity']);
        $d->addExcludePaths([0 => '/var/www/vhosts/pruebas.devblinders.com/proyectointegrado.ismael.com/modules/productcomments/src/Entity/index.php']);
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/var/www/vhosts/pruebas.devblinders.com/proyectointegrado.ismael.com/modules/ps_checkout/src/Entity']);
        $e->addExcludePaths([0 => '/var/www/vhosts/pruebas.devblinders.com/proyectointegrado.ismael.com/modules/ps_checkout/src/Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/var/www/vhosts/pruebas.devblinders.com/proyectointegrado.ismael.com/src/PrestaShopBundle/Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('/var/www/vhosts/pruebas.devblinders.com/proyectointegrado.ismael.com/var/cache/prod//doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_d0f329c34dda26746e0b29923eb9e463e1c12bc53a45d53f84076ab07a1282bb');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/var/www/vhosts/pruebas.devblinders.com/proyectointegrado.ismael.com/var/cache/prod//localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(${($_ = isset($this->services['prestashop.core.localization.cldr.cache.adapter']) ? $this->services['prestashop.core.localization.cldr.cache.adapter'] : ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/var/www/vhosts/pruebas.devblinders.com/proyectointegrado.ismael.com/var/cache/prod//localization'))) && false ?: '_'});
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.7.4', '/var/www/vhosts/pruebas.devblinders.com/proyectointegrado.ismael.com');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => '/var/www/vhosts/pruebas.devblinders.com/proyectointegrado.ismael.com/app',
            'kernel.project_dir' => '/var/www/vhosts/pruebas.devblinders.com/proyectointegrado.ismael.com',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/var/www/vhosts/pruebas.devblinders.com/proyectointegrado.ismael.com/var/cache/prod/',
            ...
            'ps_cache_dir' => '/var/www/vhosts/pruebas.devblinders.com/proyectointegrado.ismael.com/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/vhosts/pruebas.devblinders.com/proyectointegrado.ismael.com/var/cache/prod//doctrine/orm/Proxies',
