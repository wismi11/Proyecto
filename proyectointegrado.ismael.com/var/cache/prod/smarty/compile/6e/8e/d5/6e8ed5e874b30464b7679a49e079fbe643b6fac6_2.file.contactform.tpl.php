...
/* Smarty version 3.1.39, created on 2021-06-07 22:56:15
  from '/var/www/vhosts/pruebas.devblinders.com/proyectointegrado.ismael.com/themes/classicblinders/modules/contactform/views/templates/widget/contactform.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_60be87ef791c89_07747804',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6e8ed5e874b30464b7679a49e079fbe643b6fac6' => 
    array (
      0 => '/var/www/vhosts/pruebas.devblinders.com/proyectointegrado.ismael.com/themes/classicblinders/modules/contactform/views/templates/widget/contactform.tpl',
      1 => 1617704757,
      2 => 'file',
    ),
  ),
...
function content_60be87ef791c89_07747804 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <?php if (!$_smarty_tpl->tpl_vars['notifications']->value || $_smarty_tpl->tpl_vars['notifications']->value['nw_error']) {?>
      <section class="form-fields">
        ...
        <div class="form-group row">
          <div class="col-md-12">
            <label class="form-control-label has_value"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Subject','d'=>'Shop.Forms.Labels'),$_smarty_tpl ) );?>
</label>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <div class="form-group row">
          <div class="col-md-12">
            <label class="form-control-label has_value"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Email address','d'=>'Shop.Forms.Labels'),$_smarty_tpl ) );?>
</label>
            <input
              class="form-control"
              name="from"
...
"
        ...
        <?php if ($_smarty_tpl->tpl_vars['contact']->value['orders']) {?>
          <div class="form-group row">
            <div class="col-md-12">
              <label class="form-control-label has_value"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Order reference','d'=>'Shop.Forms.Labels'),$_smarty_tpl ) );?>
</label>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['contact']->value['allow_file_upload']) {?>
          <div class="form-group row">
            <div class="col-md-12">
              <label class="form-control-label has_value"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Attachment','d'=>'Shop.Forms.Labels'),$_smarty_tpl ) );?>
</label>
              <input type="file" name="fileUpload" class="filestyle" data-buttonText="<i class='material-icons'>upload_file</i><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Choose file','d'=>'Shop.Theme.Actions'),$_smarty_tpl ) );?>
">
            </div>
            <span class="col-md-3 form-control-comment">
              <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'optional','d'=>'Shop.Forms.Help'),$_smarty_tpl ) );?>
        ...
        <div class="form-group row">
          <div class="col-md-12">
            <label class="form-control-label has_value_textarea"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Message','d'=>'Shop.Forms.Labels'),$_smarty_tpl ) );?>
</label>
            <textarea
              class="form-control"
              name="message"
