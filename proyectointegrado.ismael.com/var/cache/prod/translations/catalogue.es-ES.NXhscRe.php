...
$catalogue = new MessageCatalogue('es-ES', array (
  ...
  array (
    ...
    'unit' => 'unit',
    'Resume' => 'Resume',
    'Your cart has %products_count% item(s)' => 'Your cart has %products_count% item(s)',
  ...
  array (
    ...
    'Take advantage of our exclusive offers:' => 'Cupones disponibles:',
    'Add' => 'Añadir',
    'Continue' => 'Continuar',
    'edit' => 'Modificar',
    ...
    'Print out' => 'Imprimir',
    'Send reset link' => 'Restablecer contraseña',
    'Back to login' => 'Volver a Inicio de sesión',
    'Back to Login' => 'Volver a inicio',
    'Change Password' => 'Cambiar la contraseña',
    'I am already a customer' => 'Ya soy cliente',
    'Order detail' => 'Detalles del pedido',
    'Download invoice' => 'Descargar factura',
    'Report incident' => 'Comunicar incidencia',
    'Make a refund' => 'Hacer devolución',
    'View more' => 'Ver más',
  ...
  array (
    ...
    'Promo code' => 'Introduce un cupón',
    'Have a promo code?' => 'Tengo un cupón',
    'Close' => 'Cerrar',
    ...
    'Your cart has %products_count% item(s)' => 'Tu cesta tiene %products_count% artículo(s)',
    'unit' => 'ud.',
  ),
...
Saludos',
  ...
  array (
    ...
    'I\'m new' => 'Soy nuevo',
    'Hi %firstname% %lastname% [1]you can now complete your purchase[/1]' => 'Hola %firstname% %lastname% [1]Ya puedes completar tu compra[/1]',
    'Hi %firstname% [1]you can now complete your purchase[/1]' => 'Hola %firstname% [1]Ya puedes completar tu compra[/1]',
    'Hi %customerName%' => 'Hola %customerName%',
    'Account summary' => 'Resumen de la cuenta',
    'My account' => 'Mi cuenta',
    'My orders' => 'Mis pedidos',
    'Discount coupons' => 'Cupones descuento',
    'Personal information' => 'Datos personales',
    'My Addresses' => 'Mis direcciones',
    'Sign off' => 'Cerrar sesión',
    'Contact' => 'Contacto',
    'Contact Form' => 'Formulario de contacto',
    'In the "My account" section you can edit your personal data, addresses and review your latest orders.' => 'En el apartado "Mi cuenta" puedes editar tus datos personales, direcciones y revisar tus últimos pedidos.',
    'Orders' => 'Pedidos',
    'Track, return products, repeat orders or request invoices.' => 'Realizar seguimiento, devolución de productos, repetir pedidos o solicitar facturas.',
    'Discover the discounted vouchers we have for you.' => 'Descubre los vales descuneto que tenemos para tí.',
    'Edit your personal data such as name, password, email ...' => 'Edita tus datos personales como nombre, contraseña, correo...',
    'Edit, create or delete your shipping and billing addresses.' => 'Edita, crea o elimina tus direcciones de envío y facturación.',
    'Others' => 'Otros',
    'For any questions, contact our customer service team' => 'Para cualquier duda, contacta con nuestro equipo de atención al cliente',
    'Purchased on %date% | Order reference' => 'Comprado el %date% | Referencia del pedido',
    'Shipping Address' => 'Dirección de envío',
    'Billing Address' => 'Dirección de facturación',
    'Secure connection' => 'Conexión segura',
    'Purchased on %date%' => 'Comprado el %date%',
    'Order reference' => 'Referencia del pedido',
  ),
  ...
  array (
    ...
    'Review this credit slip and download your invoice on our shop, go to the <a href="{history_url}" target="_blank">%credit_slips_label%</a> section of your customer account.' => 'Resive este cupón de descuento y descargue su factura desde nuestra tienda, diríjase a la sección <a href="{history_url}" target="_blank">%credit_slips_label%</a> de su cuenta de cliente.',
...
',
  ...
  array (
    ...
    'Write your review' => 'Opina sobre este producto',
    ...
    'By %1$s the' => 'por %1$s el',
    'verified opinion' => 'Opinión verificada',
  ),
  ...
  array (
    ...
    '%copyright% %year% - %shop% - All rights reserved' => '%copyright% %year% - %shop% - Todos los derechos reservados',
    'Subscribe to the best offers' => 'Suscríbete a las mejores ofertas',
    'Follow us on rrss!' => '¡Síguenos en redes sociales!',
  ),
...
Las categorías desactivadas se muestran en cursiva.',
    ...
    'To add combinations, you first need to create proper attributes and values in [1]%attributes_and_features_label%[/1]. <br> When done, you may enter the wanted attributes (like "size" or "color") and their respective values ("XS", "red", "all", etc.) in the field below; or simply select them from the right column. Then click on "%generate_label%": it will automatically create all the combinations for you!' => 'Para agregar combinaciones, primero debe crear los atributos y valores adecuados en [1]%attributes_and_features_label%[/1]. <br> Cuando termine, puede ingresar los atributos deseados (como "tamaño" o "color") y sus respectivos valores ("XS", "rojo", "todos", etc.) en el campo siguiente; o simplemente selecciónelos de la columna de la derecha. Luego haga clic en "%generate_label%": ¡creará automáticamente todas las combinaciones!',
