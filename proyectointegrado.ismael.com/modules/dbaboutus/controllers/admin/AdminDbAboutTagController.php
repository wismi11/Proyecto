...
class AdminDbAboutTagController extends ModuleAdminController
{
    ...
    public function initProcess()
    {
        ...
        if ($isStatusAction)
        {
            DbAboutUsTag::isToggleStatus((int)Tools::getValue('id_dbaboutus_tag'));
        }
    ...
    public function renderForm()
    {
        ...
        if (Tools::isSubmit('add'.$this->table)) {
            $this->toolbar_title = $this->l('Crear Etiqueta');
        } else {
            $this->toolbar_title = $this->l('Editar Etiqueta');
        }
