...
class Glosario extends ObjectModel
{
    public $id;
    public $active;
    public $name;
    ...
    public static function getGlossaries(
        ...
        $sql = 'SELECT l.*, ll.*
                FROM `' . _DB_PREFIX_ . 'diccionario` l
                LEFT JOIN `' . _DB_PREFIX_ . 'diccionario_lang` ll ON (l.`id_diccionario` = ll.`id_diccionario`)
